  ...
  return(
    <main className="  min-h-screen h-screen flex-col items-center justify-between p-24 ml-auto"style={{ backgroundColor: 'black' }}>
      ...
      <p>
        ...
        <p>
        <Link href="/week-5" className=" hover:text-green-500 hover:underline">
        Week 5 Assignment
        </Link>
         </p>
         <p>
        <Link href="/week-6" className=" hover:text-green-500 hover:underline">
        Week 6 Assignment
        </Link>
         </p>
         <p>
        <Link href="/week-7" className=" hover:text-green-500 hover:underline">
        Week 7 Assignment
        </Link>
         </p>
         <p>
        <Link href="/week-8" className=" hover:text-green-500 hover:underline">
        Week 8 Assignment
        </Link>
         </p>
         <p>
